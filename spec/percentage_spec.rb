...
RSpec.describe Percentage do
  ...
  describe '#positive?' do
    context 'with a positive value' do
      ...
      it 'returns true' do
        expect(percentage.positive?).to eq(true)
      end
    end
    ...
    context 'with a negative value' do
      ...
      it 'returns false' do
        expect(percentage.positive?).to eq(false)
      end
    end
  end
  ...
  describe '#negative?' do
    context 'with a negative value' do
      ...
      it 'returns true' do
        expect(percentage.negative?).to eq(true)
      end
    end
    ...
    context 'with a positive value' do
      ...
      it 'returns false' do
        expect(percentage.negative?).to eq(false)
      end
    end
  end
end
